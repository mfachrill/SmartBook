    ...
    <div class="min-h-screen flex">
        <div class="hidden lg:block w-1/2 bg-gradient-to-br from-indigo-800 to-gray-800 relative">
            <div class="absolute inset-0 bg-opacity-50 bg-black flex items-center justify-center p-12">
                <div class="text-white max-w-md">
                    <h1 class="text-4xl font-bold mb-4">Atur Ulang Kata Sandi</h1>
                    <p class="text-lg text-gray-300 mb-8">Buat kata sandi baru untuk akun <span class="text-white font-medium">Buku</span><span class="text-yellow-400 font-medium">Kita</span> Anda.</p>
                    <div class="flex space-x-4">
                        <div class="w-12 h-1 bg-yellow-400 mt-3"></div>
                        <div>
                            <blockquote class="italic">"Kata sandi yang kuat adalah kunci keamanan petualangan membaca Anda."</blockquote>
        ...
        <div class="w-full lg:w-1/2 bg-white flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <h2 class="text-2xl font-bold text-center text-gray-800 mb-2">Buat Kata Sandi Baru</h2>
                <p class="text-center text-gray-600 mb-8">Masukkan email dan kata sandi baru Anda</p>
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                    ...
                    <div>
                        <x-input-label for="password" :value="__('Kata Sandi Baru')" class="block text-sm font-medium text-gray-700 mb-1" />
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
